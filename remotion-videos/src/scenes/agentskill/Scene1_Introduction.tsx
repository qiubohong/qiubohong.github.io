...
export const AgentSkill_Scene1_Introduction: React.FC = () => {
        ...
        >
            ...
            <div style={{
                ...
                <div style={{
                    ...
                    <div>
                        <h2 style={{ fontSize: "28px", fontWeight: "bold", color: "#58a6ff", marginBottom: "6px" }}>
                            一句话核心
                        </h2>
                        <p style={{ fontSize: "24px", color: THEME.textPrimary }}>
                            可复用的知识包，为 Claude 提供特定领域的<span style={{ color: THEME.accent, fontWeight: "bold" }}>工作流程、上下文和最佳实践</span>
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div style={{
                ...
                <div style={{
                    ...
                    <div style={{ flex: 1, textAlign: "center", padding: "12px", background: "rgba(139,148,158,0.1)", borderRadius: "12px" }}>
                        ...
                        <div style={{ fontSize: "22px", color: THEME.textSecondary, fontWeight: "bold" }}>提示词</div>
                        <div style={{ fontSize: "20px", color: THEME.textSecondary }}>一次性对话级指令</div>
                    </div>
                    <div style={{ fontSize: "36px", color: THEME.accent }}>VS</div>
                    <div style={{ flex: 1, textAlign: "center", padding: "12px", background: "rgba(240,136,62,0.1)", borderRadius: "12px", border: "1px solid rgba(240,136,62,0.2)" }}>
                        <div style={{ fontSize: "36px", marginBottom: "6px" }}>📋</div>
                        <div style={{ fontSize: "22px", color: THEME.accent, fontWeight: "bold" }}>Skill</div>
                        <div style={{ fontSize: "20px", color: THEME.textPrimary }}>按需加载，<span style={{ color: THEME.accentAlt, fontWeight: "bold" }}>永久复用</span></div>
                    </div>
                </div>
            </div>
            ...
            <div style={{
                ...
                <Img
                    src={staticFile("AgentSkillVideo/scene1-image.png")}
                    style={{
                        maxWidth: "100%",
                        maxHeight: "100%",
                        objectFit: "contain",

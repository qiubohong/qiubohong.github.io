        ...
        >
            ...
            {frame > 20 && (
                <div style={{
                    ...
                    <p style={{ fontSize: "20px", color: "#3fb950", margin: "0 0 10px 0", fontWeight: "bold" }}>
                        🔧 一键诊断修复工具
                    </p>
                    <code style={{
                        fontSize: "28px",
                ...
                {ISSUES.map((issue, i) => {
                    ...
                    return (
                        <div key={i} style={{
                            ...
                            <p style={{ fontSize: "22px", color: issue.color, fontWeight: "bold", margin: "0 0 8px 0" }}>
                                {issue.q}
                            </p>
                            <p style={{ fontSize: "20px", color: THEME.textSecondary, margin: 0, whiteSpace: "pre-line", lineHeight: 1.6 }}>
                                {issue.a}
                            </p>
                        </div>
                    );

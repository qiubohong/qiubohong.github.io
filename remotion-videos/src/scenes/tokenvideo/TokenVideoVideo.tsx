...
const SCENE_DURATIONS = {
  scene1: 770, // 24.64秒音频 + 30帧缓冲
  scene2: 940, // 30.32秒音频 + 30帧缓冲
  scene3: 887, // 28.56秒音频 + 30帧缓冲
  scene4: 1330, // 40.00秒音频 + 30帧缓冲
  scene5: 1199, // 38.96秒音频 + 30帧缓冲
  scene6: 1079, // 34.96秒音频 + 30帧缓冲
  ending: 122, // 3.04秒音频 + 30帧缓冲
};

                    ...
                    return (
                        <div key={i} style={{
                            ...
                            <div style={{ display: "flex", alignItems: "center", gap: "10px" }}>
                                ...
                                <div>
                                    <p style={{ fontSize: "32px", fontWeight: 900, color: p.color, margin: 0 }}>{p.name}</p>
                                    <p style={{ fontSize: "24px", color: THEME.textPrimary, margin: 0 }}>{p.tokens}</p>
                                </div>
                            </div>
                            ...
                            <div style={{ flex: 1 }}>
                                {p.features.map((f, j) => (
                                    <div key={j} style={{
                                        ...
                                        <span style={{ fontSize: "24px", color: THEME.textPrimary }}>{f}</span>
                                    </div>
                                ))}
                            </div>
                        </div>

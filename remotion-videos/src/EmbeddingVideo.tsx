...
export const EmbeddingVideo: React.FC<EmbeddingVideoProps> = ({
    ...
    const sceneDurations = {
        scene1: 648,  // 20.60秒音频 + 30帧缓冲
        scene2: 616,  // 19.54秒音频 + 30帧缓冲
        scene3: 751,  // 24.04秒音频 + 30帧缓冲
        scene4: 522,  // 16.42秒音频 + 30帧缓冲
        scene5: 620,  // 19.70秒音频 + 30帧缓冲
        scene6: 752,  // 24.10秒音频 + 30帧缓冲
        scene7: 632,  // 20.10秒音频 + 30帧缓冲
        scene8: 1222,  // 39.76秒音频 + 30帧缓冲
        ending: 118,  // 2.95秒音频 + 30帧缓冲
    };

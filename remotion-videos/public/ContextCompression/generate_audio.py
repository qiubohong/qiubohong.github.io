...
# 脚本所在目录（public/ContextCompression）
...
SCENES = {
    ...
    "scene2": {"name": "为什么AI会吃撑",   "caption_file": "scene2-captions.json", "output_file": "scene2-audio.mp3"},
    "scene3": {"name": "什么是上下文压缩", "caption_file": "scene3-captions.json", "output_file": "scene3-audio.mp3"},
    "scene4": {"name": "三步搞定压缩",     "caption_file": "scene4-captions.json", "output_file": "scene4-audio.mp3"},
    "scene5": {"name": "多轮压缩进阶",     "caption_file": "scene5-captions.json", "output_file": "scene5-audio.mp3"},
    "scene6": {"name": "四大使用场景",     "caption_file": "scene6-captions.json", "output_file": "scene6-audio.mp3"},
    "scene7": {"name": "七技能总结",       "caption_file": "scene7-captions.json", "output_file": "scene7-audio.mp3"},

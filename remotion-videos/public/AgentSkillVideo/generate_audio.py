...
# -*- coding: utf-8 -*-
"""
AgentSkillVideo 音频生成脚本（Agent Skill - 给 AI 准备专属工作说明书）
...
# 场景配置：从字幕文件读取文本
SCENES = {
    "scene1": {"name": "开场介绍",   "caption_file": "scene1-captions.json", "output_file": "scene1-audio.mp3"},
    "scene2": {"name": "组成部分",   "caption_file": "scene2-captions.json", "output_file": "scene2-audio.mp3"},
    "scene3": {"name": "核心原理",   "caption_file": "scene3-captions.json", "output_file": "scene3-audio.mp3"},
    "scene4": {"name": "案例实战",   "caption_file": "scene4-captions.json", "output_file": "scene4-audio.mp3"},
    "scene5": {"name": "最佳实践",   "caption_file": "scene5-captions.json", "output_file": "scene5-audio.mp3"},
    "scene6": {"name": "总结对比",   "caption_file": "scene6-captions.json", "output_file": "scene6-audio.mp3"},
    "ending": {"name": "结尾",       "caption_file": "ending-captions.json", "output_file": "ending-audio.mp3"},
}

# 需要强制重新生成的场景（字幕已更新）
FORCE_REGENERATE = {"scene1", "scene3", "scene4", "scene6"}
...
def main():
    print("=" * 60)
    print("AgentSkillVideo 音频生成（Agent Skill - 给 AI 准备专属工作说明书）")
    print("=" * 60)

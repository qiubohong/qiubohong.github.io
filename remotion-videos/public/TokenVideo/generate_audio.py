...
# -*- coding: utf-8 -*-
"""
TokenVideo 音频生成脚本（大模型 Token 是什么）
...
# 场景配置：从字幕文件读取文本
SCENES = {
    "scene1": {"name": "介绍",     "caption_file": "scene1-captions.json", "output_file": "scene1-audio.mp3"},
    "scene2": {"name": "定义",     "caption_file": "scene2-captions.json", "output_file": "scene2-audio.mp3"},
    "scene3": {"name": "类型",     "caption_file": "scene3-captions.json", "output_file": "scene3-audio.mp3"},
    "scene4": {"name": "成本计算", "caption_file": "scene4-captions.json", "output_file": "scene4-audio.mp3"},
    "scene5": {"name": "应用案例", "caption_file": "scene5-captions.json", "output_file": "scene5-audio.mp3"},
    "scene6": {"name": "总结",     "caption_file": "scene6-captions.json", "output_file": "scene6-audio.mp3"},
...
def main():
    print("=" * 60)
    print("TokenVideo 音频生成（大模型 Token 是什么）")
    print("=" * 60)

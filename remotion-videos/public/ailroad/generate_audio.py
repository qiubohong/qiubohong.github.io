...
SCENE_CONFIG = {
    ...
    "scene2": {
        "name": "前置知识",
        "caption_file": "scene2-prerequisites-captions.json",
        "output_file": "scene2-prerequisites.mp3"
    },
    "scene3": {
        "name": "入门能力",
        "caption_file": "scene3-beginner-captions.json",
        "output_file": "scene3-beginner.mp3"
    },
    "scene4": {
        "name": "进阶能力",
        "caption_file": "scene4-intermediate-captions.json",
        "output_file": "scene4-intermediate.mp3"
    },
    "scene5": {
        "name": "高级能力",
        "caption_file": "scene5-advanced-captions.json",
        "output_file": "scene5-advanced.mp3"
    },
    "scene6": {
        "name": "后续发展",
        "caption_file": "scene6-career-captions.json",
        "output_file": "scene6-career.mp3"
    },
    "scene7": {
        "name": "总结",
        "caption_file": "scene7-summary-captions.json",
        "output_file": "scene7-summary.mp3"
    }
}
...
if __name__ == "__main__":
    print("=" * 60)
    print("AI学习路线视频 - Qwen3-TTS音频生成工具")
    print("=" * 60)
    ...
    if success:
        ...
        print("2. 运行 'npm run render -- AILearningRoadVideo' 渲染最终视频")
        print("3. 音频文件位置: public/ailroad/")

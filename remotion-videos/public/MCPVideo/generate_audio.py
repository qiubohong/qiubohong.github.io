...
# -*- coding: utf-8 -*-
"""
MCPVideo 音频生成脚本（MCP 协议 - AI 世界的 USB-C 接口）
...
SCENES = {
    ...
    "scene2": {"name": "核心架构",   "caption_file": "scene2-captions.json", "output_file": "scene2-audio.mp3"},
    "scene3": {"name": "服务器搭建", "caption_file": "scene3-captions.json", "output_file": "scene3-audio.mp3"},
    "scene4": {"name": "客户端调用", "caption_file": "scene4-captions.json", "output_file": "scene4-audio.mp3"},
    "scene5": {"name": "MCP生态",    "caption_file": "scene5-captions.json", "output_file": "scene5-audio.mp3"},
    "scene6": {"name": "冷知识",     "caption_file": "scene6-captions.json", "output_file": "scene6-audio.mp3"},
...
def main():
    print("=" * 60)
    print("MCPVideo 音频生成（MCP 协议 - AI 世界的 USB-C 接口）")
    print("=" * 60)

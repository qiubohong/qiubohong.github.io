...
SCENES = {
    ...
    "scene2": {"name": "为什么会乱",       "caption_file": "scene2-captions.json", "output_file": "scene2-audio.mp3"},
    "scene3": {"name": "第一步建文件夹",   "caption_file": "scene3-captions.json", "output_file": "scene3-audio.mp3"},
    "scene4": {"name": "第二步存PDF",      "caption_file": "scene4-captions.json", "output_file": "scene4-audio.mp3"},
    "scene5": {"name": "第三步按部门分类", "caption_file": "scene5-captions.json", "output_file": "scene5-audio.mp3"},
    "scene6": {"name": "定期除草维护",     "caption_file": "scene6-captions.json", "output_file": "scene6-audio.mp3"},
    "scene7": {"name": "八技能总结",       "caption_file": "scene7-captions.json", "output_file": "scene7-audio.mp3"},

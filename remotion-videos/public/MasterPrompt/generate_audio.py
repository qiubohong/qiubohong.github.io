...
SCENES = {
    ...
    "scene2": {"name": "为什么AI总像陌生人",  "caption_file": "scene2-captions.json", "output_file": "scene2-audio.mp3"},
    "scene3": {"name": "大师提示词写什么",    "caption_file": "scene3-captions.json", "output_file": "scene3-audio.mp3"},
    "scene4": {"name": "偷懒技巧",            "caption_file": "scene4-captions.json", "output_file": "scene4-audio.mp3"},
    "scene5": {"name": "进阶玩法：多身份",    "caption_file": "scene5-captions.json", "output_file": "scene5-audio.mp3"},
    "scene6": {"name": "总结收尾",            "caption_file": "scene6-captions.json", "output_file": "scene6-audio.mp3"},

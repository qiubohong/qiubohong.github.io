...
SCENES = {
    ...
    "scene2": {"name": "为什么差不多是差很多", "caption_file": "scene2-captions.json", "output_file": "scene2-audio.mp3"},
    "scene3": {"name": "给具体的反馈",        "caption_file": "scene3-captions.json", "output_file": "scene3-audio.mp3"},
    "scene4": {"name": "用画布锁定核心",      "caption_file": "scene4-captions.json", "output_file": "scene4-audio.mp3"},
    "scene5": {"name": "总结收尾",            "caption_file": "scene5-captions.json", "output_file": "scene5-audio.mp3"},

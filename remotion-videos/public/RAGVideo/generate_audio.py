...
# 脚本所在目录（public/RAGVideo）
SCRIPT_DIR = Path(os.path.dirname(os.path.abspath(__file__)))
# 项目根目录（remotion-videos）
PROJECT_ROOT = SCRIPT_DIR.parent.parent
OUTPUT_DIR = SCRIPT_DIR / "audios"

# 场景配置：从字幕文件读取文本
SCENES = {
    "scene1": {"name": "开场引入",              "caption_file": "scene1-captions.json", "output_file": "scene1.mp3"},
    "scene2": {"name": "为什么需要RAG",          "caption_file": "scene2-captions.json", "output_file": "scene2.mp3"},
    "scene3": {"name": "系统架构",               "caption_file": "scene3-captions.json", "output_file": "scene3.mp3"},
    "scene4": {"name": "工作流程",               "caption_file": "scene4-captions.json", "output_file": "scene4.mp3"},
    "scene5": {"name": "知识库构建",             "caption_file": "scene5-captions.json", "output_file": "scene5.mp3"},
    "scene6": {"name": "语义检索",               "caption_file": "scene6-captions.json", "output_file": "scene6.mp3"},
    "scene7": {"name": "实战案例",               "caption_file": "scene7-captions.json", "output_file": "scene7.mp3"},
    "scene8": {"name": "RAG vs 微调",            "caption_file": "scene8-captions.json", "output_file": "scene8.mp3"},
    "scene9": {"name": "结尾",                   "caption_file": "scene9-captions.json", "output_file": "scene9.mp3"},
}
...
def main():
    ...
    for scene_id, scene in SCENES.items():
        caption_file = SCRIPT_DIR / scene["caption_file"]

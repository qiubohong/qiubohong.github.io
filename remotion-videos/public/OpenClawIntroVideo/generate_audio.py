...
# -*- coding: utf-8 -*-
"""
OpenClawIntroVideo 音频生成脚本（普通人也能用好 OpenClaw（龙虾）—— 系列介绍）
...
# 脚本所在目录（public/OpenClawIntroVideo）
...
SCENES = {
    ...
    "scene2": {"name": "对比说明",   "caption_file": "scene2-captions.json", "output_file": "scene2-audio.mp3"},
    "scene3": {"name": "入门方式",   "caption_file": "scene3-captions.json", "output_file": "scene3-audio.mp3"},
    "scene4": {"name": "路线图",     "caption_file": "scene4-captions.json", "output_file": "scene4-audio.mp3"},
    "scene5": {"name": "案例演示",   "caption_file": "scene5-captions.json", "output_file": "scene5-audio.mp3"},
    "scene6": {"name": "总结互动",   "caption_file": "scene6-captions.json", "output_file": "scene6-audio.mp3"},
...
def main():
    print("=" * 60)
    print("OpenClawIntroVideo 音频生成（普通人也能用好 OpenClaw（龙虾）—— 系列介绍）")
    print("=" * 60)

...
SCENES = {
    ...
    "scene2": {"name": "AI讨好型人格",     "caption_file": "scene2-captions.json", "output_file": "scene2-audio.mp3"},
    "scene3": {"name": "三步建立批评家",   "caption_file": "scene3-captions.json", "output_file": "scene3-audio.mp3"},
    "scene4": {"name": "第一性原理深挖",   "caption_file": "scene4-captions.json", "output_file": "scene4-audio.mp3"},
    "scene5": {"name": "被批评是成长",     "caption_file": "scene5-captions.json", "output_file": "scene5-audio.mp3"},
    "scene6": {"name": "六技能总结",       "caption_file": "scene6-captions.json", "output_file": "scene6-audio.mp3"},

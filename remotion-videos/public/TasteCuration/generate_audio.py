...
SCENES = {
    ...
    "scene2": {"name": "为什么会选很重要", "caption_file": "scene2-captions.json", "output_file": "scene2-audio.mp3"},
    "scene3": {"name": "三步提升总览",    "caption_file": "scene3-captions.json", "output_file": "scene3-audio.mp3"},
    "scene4": {"name": "第一步：建立审美库", "caption_file": "scene4-captions.json", "output_file": "scene4-audio.mp3"},
    "scene5": {"name": "第二步：精准表达", "caption_file": "scene5-captions.json", "output_file": "scene5-audio.mp3"},
    "scene6": {"name": "第三步：个人规则", "caption_file": "scene6-captions.json", "output_file": "scene6-audio.mp3"},
    "scene7": {"name": "总结收尾",        "caption_file": "scene7-captions.json", "output_file": "scene7-audio.mp3"},

...
# -*- coding: utf-8 -*-
"""
Embedding视频音频生成脚本（5分钟AI系列·第13期）
...
SCENES = {
    ...
    "scene2": {"name": "核心特性",              "caption_file": "scene2-captions.json", "output_file": "scene2-audio.mp3"},
    "scene3": {"name": "工作流程",              "caption_file": "scene3-captions.json", "output_file": "scene3-audio.mp3"},
    "scene4": {"name": "生态应用",              "caption_file": "scene4-captions.json", "output_file": "scene4-audio.mp3"},
...
def main():
    print("=" * 60)
    print("Embedding视频音频生成（5分钟AI系列·第13期）")
    print("=" * 60)

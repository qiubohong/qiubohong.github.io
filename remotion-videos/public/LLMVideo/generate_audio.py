...
SCENES = {
    ...
    "scene2": {"name": "核心突破",              "caption_file": "scene2-captions.json", "output_file": "scene2-audio.mp3"},
    "scene3": {"name": "为什么LLM能实现通用智能", "caption_file": "scene3-captions.json", "output_file": "scene3-audio.mp3"},
    "scene4": {"name": "LLM如何工作",           "caption_file": "scene4-captions.json", "output_file": "scene4-audio.mp3"},
    "scene5": {"name": "LLM三大架构对比",       "caption_file": "scene5-captions.json", "output_file": "scene5-audio.mp3"},
    "scene6": {"name": "冷知识分享",            "caption_file": "scene6-captions.json", "output_file": "scene6-audio.mp3"},
...
def main():
    print("=" * 60)
    print("LLM大模型视频音频生成（5分钟AI系列·第11期）")
    print("=" * 60)

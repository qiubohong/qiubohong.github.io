...
# -*- coding: utf-8 -*-
"""
OpenClawInstallVideo 音频生成脚本（普通人也能用好 OpenClaw（龙虾）—— 安装龙虾）
...
# 脚本所在目录（public/OpenClawInstallVideo）
...
def main():
    print("=" * 60)
    print("OpenClawInstallVideo 音频生成（普通人也能用好 OpenClaw（龙虾）—— 安装龙虾）")
    print("=" * 60)

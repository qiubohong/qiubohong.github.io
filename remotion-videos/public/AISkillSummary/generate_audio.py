...
# 场景配置：从字幕文件读取文本
SCENES = {
    "scene1": {"name": "开场对比",         "caption_file": "scene1-captions.json", "output_file": "scene1-audio.mp3"},
    "scene2": {"name": "九技能回顾",        "caption_file": "scene2-captions.json", "output_file": "scene2-audio.mp3"},
    "scene3": {"name": "职场周报案例",      "caption_file": "scene3-captions.json", "output_file": "scene3-audio.mp3"},
    "scene4": {"name": "编故事案例",        "caption_file": "scene4-captions.json", "output_file": "scene4-audio.mp3"},
    "scene5": {"name": "创业决策案例",      "caption_file": "scene5-captions.json", "output_file": "scene5-audio.mp3"},
    "scene6": {"name": "团队统一案例",      "caption_file": "scene6-captions.json", "output_file": "scene6-audio.mp3"},
    "scene7": {"name": "终身学习案例",      "caption_file": "scene7-captions.json", "output_file": "scene7-audio.mp3"},
    "scene8": {"name": "技能组合卡",        "caption_file": "scene8-captions.json", "output_file": "scene8-audio.mp3"},

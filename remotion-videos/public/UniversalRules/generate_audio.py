...
SCENES = {
    ...
    "scene2": {"name": "什么是通用规则",   "caption_file": "scene2-captions.json", "output_file": "scene2-audio.mp3"},
    "scene3": {"name": "为什么重要",       "caption_file": "scene3-captions.json", "output_file": "scene3-audio.mp3"},
    "scene4": {"name": "三步建立规则",     "caption_file": "scene4-captions.json", "output_file": "scene4-audio.mp3"},

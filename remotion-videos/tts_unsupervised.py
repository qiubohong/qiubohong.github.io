...
def generate_all_scene_audios():
    ...
    if success_count == len(SCENE_CONFIG):
        print("🎉 所有场景处理完成！")
        print("📁 音频文件位置: public/UnsupervisedLearningVideo/")
...
if __name__ == "__main__":
    print("=" * 60)
    print("无监督学习动画视频 - Qwen3-TTS音频生成工具")
    print("=" * 60)
    ...
    if success:
        ...
        print("2. 运行 'npm run build:unsupervised' 渲染最终视频")
        print("3. 音频文件位置: public/UnsupervisedLearningVideo/")
        print("💡 技术特点:")

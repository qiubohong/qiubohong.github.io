...
![Trace 分析驱动持续迭代流程图](/assets/img/ailearn/harness/05/trace_analysis_flow.png)

这个流程和机器学习里的"Boosting"很像
---
...
![推理三明治策略流程图——规划与验证用 xhigh，实现用 high](/assets/img/ailearn/harness/05/reasoning_sandwich_flow.png)

这个设计的逻辑是
这个设计的逻辑是：规划和验证是最需要"想清楚"的阶段，值得花更多推理预算。实现阶段相对机械，用中等推理预算就够了。

![推理三明治策略——让推理预算花在刀刃上](/assets/img/ailearn/harness/05/reasoning_sandwich.png)
...
![Trace 分析三个关键点——让 AI 改进从靠感觉变成靠数据](/assets/img/ailearn/harness/05/three_key_points.png)

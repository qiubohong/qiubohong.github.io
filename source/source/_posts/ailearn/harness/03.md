...
![上下文工程三个核心原则](/assets/img/ailearn/harness/03/context_engineering_principles.png)
...
_最后更新：YYYY-MM-DD by [更新人]_
_如果发现本文件有过时内容，请更新它。_
```
...
- [x] [已完成的功能 1]（文件：path/to/file1.py）
- [x] [已完成的功能 2]（文件：path/to/file2.py）
- [ ] [进行中的功能 3]（完成度：70%）
...
1. [注意事项 1：例如 - auth middleware 的顺序很重要]
2. [注意事项 2：例如 - 数据库表 X 和 Y 有外键关联]
...
_请接手的 AI 实例先通读此文档，确认理解后再继续工作。_
_如有疑问优先查阅上述相关文件。_
```

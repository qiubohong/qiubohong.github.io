...
![ReAct 工作循环](/assets/img/ailearn/daily/23/23_react_loop.png)
...
来看一个能跑起来的完整例子，下图展示了 ReAct Agent 的核心架构：

![ReAct Agent 架构](/assets/img/ailearn/daily/23/23_agent_architecture.png)
